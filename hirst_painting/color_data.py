"""Color palette data for the Hirst painting project.

This module defines a list of RGB color tuples that represent the
paint colors used to render the dot grid in the main drawing module.
"""

# Each item is an (R, G, B) tuple that turtle can use with colormode 255.
pallette = [
